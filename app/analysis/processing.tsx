  ...
  if (error) {
    return (
      <View className="flex-1 bg-background items-center justify-center p-6">
        <View className="bg-error-100 rounded-lg p-6 max-w-md">
          <Text className="text-error-700 text-lg font-semibold mb-2">
            Processing Failed
          </Text>
          <Text className="text-error-600 mb-4">{error}</Text>
          <Button onPress={() => router.back()} className="bg-error-600">
